...
VALUES
(1, 'Zohan', 'zohan@2024@gmail.com', 4, 'good'),(2, 'Keyaan', 'keyaan.TR@gmail.com', 5, 'very good'),
(3, 'Zayn', 'ZAYN...@gmail', 3, 'ok'),(4, 'Emir', 'emir-#1@outlook.com', 4, 'ok'),
(5, 'Ashar', 'Ashar-@hotmail.DE', 4, 'nice'),(6, 'Zoya', 'zoya@techTFQ.org', 4, 'great'),
(7, 'Kabir', 'kabir.com@-gmail.com', 2, 'bad'),(8, 'Ayaan', 'ayaan123@company.net', 1, 'poor'),
(9, 'Meir', 'meir123@', 1.5, 'poor'),(10, 'Noah', 'noah_.com@.com', 3.5, 'bad'),
(11, 'Idris', 'i@gmail.com', 5, 'excellent'),(12, 'Arhaan', 'arhaan$gmail.com', 5, 'awesome'),
...
SELECT 
    ...
    email 
FROM feedback 
WHERE email REGEXP '^[a-zA-Z][a-zA-Z0-9_.-]*@[a-zA-Z]+\.+[a-zA-Z]{2,4}$' AND LOCATE('.', REVERSE(email)) BETWEEN 2 AND 4;
